...
import BiEngineering from "./Descriptions/BIEngineering";
import BNA from "./Descriptions/BNA";
import SparksFoundation from "./Descriptions/SparksFoundation";
...
export default function WhereIHaveWorked() {
  ...
  const GetDescription = () => {
    switch (DescriptionJob) {
      case "BiEngineering":
        return <BiEngineering />;
      case "BNA":
        return <BNA />;
      case "SparksFoundation":
        return <SparksFoundation />;
      default:
        return <BiEngineering />;
    }
  };

  const [DescriptionJob, setDescriptionJob] = React.useState("BiEngineering");
  ...
  return (
    ...
    >
      ...
      >
        {/* Left side: Bar and Company Names */}
...
const CompaniesBar = (props) => {
  ...
  return (
    ...
    >
      {/* Left bar Holder */}
      <div
        className=" hidden md:block bg-gray-500 relative h-0.5 w-34 md:h-[130px] translate-y-1 md:w-0.5  
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        <div className="flex flex-row md:flex-col">
          <CompanyButton
            ...
            CompanyName="BI Engineering"
            BarPosition={-12}
            BarAvobePosition={1}
            DescriptionJob="BiEngineering"
          ...
          <CompanyButton
            ...
            DescriptionJob="SparksFoundation"
