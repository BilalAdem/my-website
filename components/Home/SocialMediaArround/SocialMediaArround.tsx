        ...
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            ...
            <IconClickableWithAnimation
              Icon={GithubIcon}
              href={"https://github.com/BilalAdem"}
            />
            {/* Linkedin icon */}
            <IconClickableWithAnimation
              Icon={LinkedinIcon}
              href={"https://www.linkedin.com/in/bilaladem/"}
            />
            <IconClickableWithAnimation
              Icon={MailIcon}
              href={"mailto:billalademattar@gmail.com"}
            />
            {/* Instagram Icon */}
            <IconClickableWithAnimation
              Icon={InstagramIcon}
              href={"https://www.instagram.com/bilalademattar/"}
            />
          </div>
          ...
          >
            ...
            >
              <span className=" font-Header tracking-wider text-gray-400 hover:text-AAsecondary hover:cursor-pointer">
                billalademattar<span className="text-AAsecondary">@</span>gmail
