...
export default function Home() {
  ...
  const meta = {
    title: "Attar Bilal Adem - AI & Data Science Engineer",
    description: `AI & Data Science Engineer with expertise in ML, DL, NLP, and IoT. Passionate about leveraging technology for sustainability and real-world impact.`,
    image: "/img/portfolio.jpg", // Ensure this image exists in your public folder
    type: "website",
  };
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://github.com/BilalAdem`} />
        <link rel="canonical" href={`https://github.com/BilalAdem`} />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Attar Bilal Adem" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@BilalAdem" />
      ...
      {!isBlackListed ? (
        <div className="relative snap-mandatory min-h-screen bg-AAprimary w-full ">
          ...
          <Header
            ...
            sectionsRef={homeRef}
            sectionsRef2={aboutRef} // Passed this in case you need scrolling to About
          />
          ...
          {context.sharedState.finishedLoading ? (
            <Footer
              githubUrl={"https://github.com/BilalAdem/my-website"}
